...
| docs/operating-model.md       | Workflow lane model: when work is solo, shaped, team-reviewed, audited, or run as a loop                                       |
...
| docs/breakaway.md             | Fork breakaway plan: owned package scope, GitHub Packages, ai-machine install, endpoints, AGPL notes                           |
