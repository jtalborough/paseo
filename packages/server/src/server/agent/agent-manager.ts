...
function buildProjectTaskRuntimePrompt(projectGroupId: string | undefined): string | null {
  ...
  return [
    ...
    "Provider-native folder instruction files such as AGENTS.md, CLAUDE.md, GEMINI.md, or provider-specific skill/command files may be loaded by the provider with higher effective priority than a Project prompt. Treat them as execution constraints for that Folder, surface conflicts, and preserve Project decisions in Project files or tasks.",
